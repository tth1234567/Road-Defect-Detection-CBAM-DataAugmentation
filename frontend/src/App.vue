  ...
  <el-container v-else class="app-layout">
    ...
    <el-aside width="220px" class="sidebar">
      ...
      >
        ...
        <el-sub-menu index="/defects" popper-class="defect-submenu-popper">
          <template #title>
            <el-icon><Collection /></el-icon>
            <span>缺陷类型</span>
          </template>
          <el-menu-item index="/defects/pothole">坑洼</el-menu-item>
          <el-menu-item index="/defects/longitudinal-crack">纵向裂缝</el-menu-item>
          <el-menu-item index="/defects/transverse-crack">横向裂缝</el-menu-item>
          <el-menu-item index="/defects/alligator-crack">网状裂缝</el-menu-item>
        </el-sub-menu>
      </el-menu>
