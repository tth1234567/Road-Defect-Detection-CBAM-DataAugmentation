...
class C2fWithCBAM(nn.Module):
    def __init__(self, c2f_mod: C2f, r: int = 16, k: int = 7):
        super().__init__()
        self.c2f = c2f_mod
...
def main():
    ...
    parser.add_argument("--name", type=str, default="yolov8_cbam_c2f_ris_64")
    parser.add_argument("--device", type=str, default="",
                        help="设备选择，如 '0'、'0,1' 或 'cpu'（留空则自动）")
    parser.add_argument("--only_high_channels", action="store_true",
                        help="仅对高通道 C2f 注入 CBAM（更快）")
    parser.add_argument("--high_ch_threshold", type=int, default=192,
