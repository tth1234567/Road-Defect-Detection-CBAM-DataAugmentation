...
def replace_c2f_with_cbam(module: nn.Module,
                          ...
                          high_ch_threshold: int = 128) -> Tuple[int, int]:
    """
...
def main():
    ...
    parser.add_argument("--name", type=str, default="update_128_version")
    ...
    parser.add_argument("--high_ch_threshold", type=int, default=128,
