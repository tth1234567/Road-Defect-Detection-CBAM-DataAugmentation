...
class SE(nn.Module):
    ...
    # r: int = 96：缩放比例 reduction ratio，默认 96。用来把通道数压缩成更小的中间维度。等号 = 96 表示有默认值，如果你不传，就用 96。
...
def main():
    ...
    parser.add_argument("--name", type=str, default="yolov8_cbam_c2f_ris_96_high_ch_is224")
