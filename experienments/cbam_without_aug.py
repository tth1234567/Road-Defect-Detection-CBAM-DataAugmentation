...
def main():
    ...
    parser.add_argument("--data", type=str,
                        help="数据配置 data.yaml 路径（包含 train/val/test 与 names）",default=r"E:\paper\initial_class\data.yaml" )
    ...
    parser.add_argument("--name", type=str, default="yolov8_cbam_c2f_ris_32_high_ch_is224_without_augment")
